...
module.exports = {
    ...
    utils: {
        ...
        isVoiceChannel: `Ce channel est un channel vocal, Merci de choisir un channel textuel !`,
        specialMessages: {
            join: {
                ...
                unknown: (user) => `Je n'arrive pas à trouver comment ${user} a rejoint le serveur, Ou l'invitation est un invitation temporaire.`,
    ...
    errors: {
        ...
        uNotPerm: `\`Vous ne pouvez pas executer cette commande !\``,
        uHasPerm: `\`Vous pouvez executer cette commande !\``,
        activate: "\`Activé\`",
        desactivate: "\`Désactivé\`"
    },

    help: {
        title: () => `ℹ Page d'aide de SannaManager`,
        ...
        manageInvite: {
            title: () => `SannaManager`,
            content: (prefix) => `
        > **${prefix}botinfos**: Affiche des informations sur SannaManager.
        > **${prefix}ping**: Affiche le ping de SannaManager.
    ...
    botinfos: {
        ...
        // Description
        description: `\`Bot modifié par Wuzax#4019\`\n\nBase: [ManageInvite](https://github.com/ManageInvite/ManageInvite) par [Androz2091](https://github.com/Androz2091) !`,
    ...
    support: {
        content: () => `:information_source: Si vous avez des questions ou si vous avez besoin de plus d'informations, vous pouvez rejoindre Sanna :\n${discord}`
    },
    ...
    joinDM: {
        premium: (username) => `:crown: | Hey, **${username}** ! Cette fonctionnalité est disponible seulement pour les serveurs premium et les partenaires. Deviens premium ici: **https://discord.gg/ABPXVHjN4A** !`
    },

    premiumJoin: {
        premium: (username) => `:crown: | Hey, **${username}** ! Pour avoir plus de ranks, merci de passé en premium ! Deviens premium ici: **https://discord.gg/ABPXVHjN4A** !`,
        noRanks: `Vous avez dépassé le nombre maximum de ranks !`
    },
...
:pencil: **| Écrivez maintenant le message de départs... :pencil2:**`,
    ...
    serverinfo: {
        noguildfound: `**${emojis.error} | Pas de serveur trouvé pour !**`,
        noargs: `**${emojis.error} | Merci de definir l'id d'un serveur !**`,
        fields: {
            field1: {
                name: "Membres",
                value: (m) => `${m} membres`
