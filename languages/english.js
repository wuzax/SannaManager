...
module.exports = {
    ...
    utils: {
        ...
        isVoiceChannel: `This channel is voice channel, please select text channel!`,
        specialMessages: {
            join: {
                ...
                unknown: (user) => `I can't figure out how ${user} joined the server, Or invition is temporary invitation.`,
    ...
    errors: {
        ...
        uNotPerm: `\`You cannot execute this command!\``,
        uHasPerm: `\`You can execute this command!\``,
        activate: "\`Enabled\`",
        desactivate: "\`Disabled\`"
    },

    help: {
        title: () => `ℹ SannaManager's Help Page`,
        ...
        manageInvite: {
            title: () => `SannaManager`,
            content: (prefix) => `
        > **${prefix}botinfos**: Show informations about SannaManager.
        > **${prefix}ping**: Show the SannaManager's ping.
    ...
    botinfos: {
        ...
        // Description
        description: `\`Bot modifié par Wuzax#4019\`\n\nBase: [ManageInvite](https://github.com/ManageInvite/ManageInvite) by [Androz2091](https://github.com/Androz2091) !`,
    ...
    support: {
        content: () => `:information_source: If you have questions or you need more informations, you can join Sanna:\n${discord}`
    },
    ...
    joinDM: {
        premium: (username) => `:crown: | Hey, **${username}**! This feature is only available for premium servers and partners. Get premium here: **https://discord.gg/ABPXVHjN4A** !`
    },

    premiumJoin: {
        premium: (username) => `:crown: | Hey, **${username}**! to have more ranks, thank you for going to premium! Get premium here: **https://discord.gg/ABPXVHjN4A** !`,
        noRanks: `You have exceeded the maximum number of ranks!`
    },
...
:pencil: **| Now write the leave message... :pencil2:**`,
    ...
    addrank: {
        errors: {
            ...
            role: {
                missing: (prefix) => `${emojis.error} | You must mention the role you want to add when the invitation quote is reached. (Syntax: ${prefix}addrank number @role)`,
                ...
                perm: (role) => `${emojis.error} | My role is not high enough to add the role \`@${role.name}\` to members! Please assemble my role then try again!`
            }
        },
    ...
    serverinfo: {
        noguildfound: `**${emojis.error} | Server not found !**`,
        noargs: `**${emojis.error} | Please define a guild id !**`,
        fields: {
            field1: {
                name: "Members",
                value: (m) => `${m} members`
